  ...
  return (
    <div className="pb-32">
        ...
        <section id="predicciones" className="mb-16 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {matches.map(m => {
              ...
              const fechaStr = new Date(m.fechaHora).toLocaleDateString("es-ES", { 
                weekday: "short", 
                day: "numeric", 
                month: "short" 
              });
              const horaStr = new Date(m.fechaHora).toLocaleTimeString("es-ES", { 
                hour: "2-digit", 
                minute: "2-digit" 
              });
        ...
        <section className="mb-16 bg-gradient-to-r from-neutral-950 via-neutral-900 to-neutral-950 rounded-3xl p-6 sm:p-10 border-2 border-[#39FF14]/60 shadow-[0_0_30px_rgba(57,255,20,0.15)] relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center relative z-10">
            ...
            <div className="text-center lg:text-right flex flex-col items-center lg:items-end justify-center">
              ...
              <a 
                href="https://wa.me/59899123456?text=Hola%20Kanthus!%20Quiero%20hacer%20un%20pedido%20y%20sumar%20chances%20para%20la%20TV%20de%2055%20pulgadas%20de%20la%20Penca%20Mundial!" 
                target="_blank" 
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a 
          href="https://wa.me/59899123456?text=Hola%20Kanthus!%20Quiero%20pedir%20hamburguesas%20y%20sumar%20para%20la%20TV%20de%2055%20pulgadas!" 
          target="_blank" 
          rel="noopener noreferrer"
