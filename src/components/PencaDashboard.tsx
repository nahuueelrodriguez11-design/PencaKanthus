...
export default function PencaDashboard({
  ...
  // Función de atajo Admin removida por seguridad. Solo acceso con credenciales genuinas en /admin-login.
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            {currentUser ? (
              ...
              // PUNTO 3 y 6: Mostrar únicamente "Probar jugador". Acceso Admin removido completamente de la vista pública (Puntos 1 y 7).
